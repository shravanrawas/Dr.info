...
export default function WaitlistModal({ setIsModalOpen }) {
  ...
  const roles = ["Physician", "Medical Student", "Nurse", "Pharmacist"];
        ...
        <div className="relative w-full max-w-xl p-8 mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h2 className="mb-8 text-center">
              <span className="text-3xl font-medium text-[#263969]">
                Join the waitlist for the
              </span>
              <br />
              <span className="text-2xl font-medium text-[#b29efa]">
                Dr.Info!
              </span>
            </h2>
            ...
            <form className="w-full space-y-4">
              ...
              <div className="relative">
                ...
                <div
                  className={`absolute z-20 h-[128px] overflow-y-auto w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg
