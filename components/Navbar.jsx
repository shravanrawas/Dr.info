...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white/20 px-6 md:px-32 py-4 flex flex-col justify-center h-[120px] fixed w-full top-0 shadow-lg backdrop-blur-lg z-50">
        ...
        <div className="hidden md:flex gap-14 items-center">
          ...
          <div className="flex gap-2">
           ...
           <button className="border border-black rounded px-4 py-2 text-black text-lg font-medium">
            ...
            <button className="bg-black text-white rounded px-4 py-2 text-lg font-medium">
              Try for free
            </button>
          </div>
        </div>
